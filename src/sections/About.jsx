...
function About() {
      ...
      const cardItems = [
        {text : "solid",
         style : {
            rotate: "-30deg", top: "60%", left: "45%" 
         },
         image :""
        },
        {text : "Design Patterns",
         style : {
            rotate: "90deg", bottom: "30%", left: "70%" 
         },
         image :""
        },
        {text : "Design Principles",
         style : {
            rotate: "-45deg", top: "55%", left: "0%" 
         },
         image :""
        },
        {text : "SRP",
         style : {
            rotate: "20deg", top: "10%", left: "38%" 
         },
         image :""
        },
      ]
    ...
    id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12 md:w-[90%] lg:w-[80%]">
        <div className="flex items-end grid-default-color grid-1">
            <img src="assets/coding-pov.png" alt="coding image"
